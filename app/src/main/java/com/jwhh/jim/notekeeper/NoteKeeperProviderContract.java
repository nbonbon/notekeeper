...
public final class NoteKeeperProviderContract {
    ...
    public static final Uri AUHTORITY_URI = Uri.parse("content://" + AUTHORITY);
    ...
    public static final class Courses implements BaseColumns, CoursesColumns, CoursesIdColumns {
        ...
        public static final Uri CONTENT_URI = Uri.withAppendedPath(AUHTORITY_URI, PATH);
    }
    ...
    public static final class Notes implements BaseColumns, NotesColumns, CoursesIdColumns, CoursesColumns {
        ...
        public static final Uri CONTENT_EXPANDED_URI = Uri.withAppendedPath(AUHTORITY_URI, PATH_EXPANDED);
    }
}
